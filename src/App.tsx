              ...
              <DialogContent>
                ...
                <div className="space-y-4 py-4">
                  ...
                  <div className="text-xs text-slate-500">
                    <p>API URL: {API_URL}</p>
                    <p className="mt-1">Для изменения ключа отредактируйте файл .env</p>
                  </div>
                </div>
              </DialogContent>
            </Dialog>
      ...
      <div className="flex-1 flex flex-col">
        <div className="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-6 shadow-sm">
          ...
          <div className="flex items-center gap-2">
            <Badge variant="outline" className="text-slate-600">
              ...
              {selectedModel.split('/')[1] || 'AI-ассистент'}
            </Badge>
          </div>
        </div>
        ...
        <div className="p-6 bg-white border-t border-slate-200">
          ...
          <p className="text-xs text-slate-400 text-center mt-3">
            Мастер-агент автоматически определит нужного специалиста и делегирует задачу
          </p>
        </div>
      </div>
    </div>
